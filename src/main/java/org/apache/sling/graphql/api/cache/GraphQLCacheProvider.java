...
public interface GraphQLCacheProvider {
     ...
     */
    @Nullable
    String getQuery(@NotNull String hash, @NotNull String resourceType, @Nullable String selectorString);
     ...
     */
    @Nullable
    String cacheQuery(@NotNull String query, @NotNull String resourceType, @Nullable String selectorString);
}
