...
public class Directives {
    ...
    public static final DirectiveDefinition CONNECTION = DirectiveDefinition.newDirectiveDefinition()
            ...
            .inputValueDefinition(InputValueDefinition.newInputValueDefinition()
                    ...
                    .type(NonNullType.newNonNullType(
                                    TypeName.newTypeName(TYPE_STRING).build())
                            .build())
                    .build())
            .build();
    ...
    public static final DirectiveDefinition FETCHER = DirectiveDefinition.newDirectiveDefinition()
            ...
            .inputValueDefinition(InputValueDefinition.newInputValueDefinition()
                    .name("name")
                    .description(
                            new Description("The name with which the SlingDataFetcher was registered.", null, false))
                    .type(NonNullType.newNonNullType(
                                    TypeName.newTypeName(TYPE_STRING).build())
                            .build())
                    .build())
    ...
    public static final DirectiveDefinition RESOLVER = DirectiveDefinition.newDirectiveDefinition()
            ...
            .inputValueDefinition(InputValueDefinition.newInputValueDefinition()
                    .name("name")
                    .description(
                            new Description("The name with which the SlingTypeResolver was registered.", null, false))
                    .type(NonNullType.newNonNullType(
                                    TypeName.newTypeName(TYPE_STRING).build())
                            .build())
                    .build())
