...
public class DataFetcherServiceRankingTest {
    ...
    public void testDataFetcherRankings() throws IOException {
        ...
        reg40.unregister();
        assertFetcher(s, nsAndName, "DF#ns#name#43");
