...
public class MaxQueryTokensTest extends ResourceQueryTestBase {
    ...
    public static Collection<Object[]> data() {
        ...
        result.add(
                new Object[] {"default values", null, null, DEFAULT_MAX_QUERY_TOKENS - 1, DEFAULT_MAX_QUERY_TOKENS, -1
                });
    ...
    public MaxQueryTokensTest(
            String name,
            Integer maxTokens,
            Integer maxWhitespaceTokens,
            int nOk,
            int nTokensFailure,
    ...
    public void tooManyWhitespaceTokens() throws Exception {
        if (nWhitespaceFailure >= 0) {
            assertQueryFailure(
                    "{" + repeat(WHITESPACE, nWhitespaceFailure) + "}",
