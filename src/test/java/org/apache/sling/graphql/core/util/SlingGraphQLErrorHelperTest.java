    ...
    public void toSpecificatonTest() {
        ...
        try {
            ...
            final List<Map<String, Object>> errors =
                    (List<Map<String, Object>>) SlingGraphQLErrorHelper.toSpecification(customMessage, e)
                            .get(SlingGraphQLErrorHelper.GRAPHQL_ERROR_ERRORS);
            assertEquals(e.getMessage(), errors.get(0).get(SlingGraphQLErrorHelper.GRAPHQL_ERROR_MESSAGE));

            @SuppressWarnings("unchecked")
            final Map<String, Object> extensions =
                    (Map<String, Object>) errors.get(0).get(SlingGraphQLErrorHelper.GRAPHQL_ERROR_EXTENSIONS);
            ...
            assertEquals(
                    ...
                    extensions.get(SlingGraphQLErrorHelper.GRAPHQL_ERROR_CAUSE));
        }
    }
}
